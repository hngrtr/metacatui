  ...
  var CesiumVectorData = MapAsset.extend(
    /** @lends CesiumVectorData.prototype */ {
      ...
      styleBillboard: function (entity, styles) {
        ...
        // Use updated map pins
        // To Do: Make the pin image configurable
        // To Do: Use styles.markerSize for square icons
        console.log(`The color is ${styles.color.toCssHexString()}`);

        var svgImage = "<svg xmlns='http://www.w3.org/2000/svg' viewBox='-12 -12 524 524'><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill='";
        svgImage += styles.color.toCssHexString();
        svgImage += "' fill-rule='evenodd' stroke='white' stroke-width='24' d='M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z'/></svg>";
        
        entity.billboard.image = 'data:image/svg+xml;base64,' + btoa(svgImage);
